	...
	$('#form-request-video').submit(function(e){
		...
		$.post('/kinect/dataCenter.php/reqvid',data,function(msg){
			...
			if(msg.status==1){
				...
				$('.area_body').html('<div class="panel panel-default"><div class="panel-body"><h1>Congradulations!</h1>You have sent a video request successfully.<br/>Your video link is below: <br/>'+msg.alphaid+'</div></div>');
			}else{
