	...
	$('#form-request-video').submit(function(e){
		...
		$.post('/kinect/dataProcessor.php/reqvid',data,function(msg){
			...
			if(msg.status==1){
				...
				$('.area_body').html('<div class="panel panel-default col-lg-6 col-lg-offset-3"><div class="panel-body"><h1>Congradulations!</h1>You have sent a video request successfully.<br/>Your video link is below: <br/><a class="btn btn-default btn-sm" href="/kinect/video.php/dtls/'+msg.alphaid+'">Check you request</a></div></div>');
			}else{
