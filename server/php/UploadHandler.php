...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'accept_file_types' => '/\.(flv|jpe?g|mwv|mp4)$/i',
...
protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
    ...
    if ($this->validate($uploaded_file, $file, $error, $index)) {
        ...
        $file->upload_to_db = $this->add_video($this->get_download_url($file->name));
...
function add_video($whichvideo)  
{  

    $this->query("CREATE TABLE `videolink` (
      `id` int(10) unsigned NOT NULL auto_increment,
      `name` varchar(1000) collate utf8_unicode_ci NOT NULL default '',
      PRIMARY KEY (`id`)
      ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci");

    $add_to_db = $this->query("INSERT INTO videolink (name) VALUES
     ('".$whichvideo."')") or die(mysql_error());  
    return $add_to_db;  
}
